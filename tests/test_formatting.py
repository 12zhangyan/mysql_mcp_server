...
@patch("mysql_mcp_server.server.connect")
@patch("mysql_mcp_server.server.get_db_config")
async def test_list_resources_identifier_safe(
    mock_get_config, mock_connect, monkeypatch
):
...
@patch("mysql_mcp_server.server.connect")
@patch("mysql_mcp_server.server.get_db_config")
async def test_list_resources_multi_db_safe(mock_get_config, mock_connect, monkeypatch):
